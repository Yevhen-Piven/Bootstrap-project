...
class CourseServiceTest {
    ...
    public void testSave() {
        Course courseToSave = new Course(FIRS_TEST_COURSE_ID, FIRST_TEST_COURSE_NAME, FIRST_TEST_COURSE_DESCRIPTION);
        Course savedCourse = courseService.save(courseToSave);
        assertNotNull(savedCourse);
        assertEquals(courseToSave.getCourseName(), savedCourse.getCourseName());
    }
